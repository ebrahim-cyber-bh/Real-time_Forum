  ...
  async getHtml() {
    ...
    return /* HTML */ `
      <div id="user-dropdown">
        <div
          class="user-menu-panel border-2 border-white rounded absolute right-0 z-10 mt-2 w-64 flex min-h-full flex-col justify-center px-6 pb-4 lg:px-8 bg-gray-900"
        >
